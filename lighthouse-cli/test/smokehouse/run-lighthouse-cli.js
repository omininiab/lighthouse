...
// TODO(bckenny): how close can we get this to the core/index.js interface?
/**
 * Launch Chrome and do a full Lighthouse run via the CLI.
 * @param {string} url
 * @param {LH.Config.Json=} configJson
 * @param {{isDebug?: boolean}} testRunnerOptions
 * @return {Promise<SmokeResult & {stdout: string, stderr: string}>}
 */
...
async function internalRun(url, tmpPath, configJson, isDebug) {
  ...
  if (isDebug) {
    ...
    localConsole.error(`STDERR: ${execResult.stderr}`);
  }
